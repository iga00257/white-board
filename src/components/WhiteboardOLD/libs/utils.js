...
export const materialInfo = {
  width: (typeof GDATA !== 'undefined' && typeof GDATA.materialInfo !== 'undefined' && GDATA.materialInfo.width) || 800,
  height:
    (typeof GDATA !== 'undefined' && typeof GDATA.materialInfo !== 'undefined' && GDATA.materialInfo.height) || 600,
};
export function getMaterialInfo() {
  return {
    width:
      (typeof GDATA !== 'undefined' && typeof GDATA.materialInfo !== 'undefined' && GDATA.materialInfo.width) || 800,
    height:
      (typeof GDATA !== 'undefined' && typeof GDATA.materialInfo !== 'undefined' && GDATA.materialInfo.height) || 600,
  };
}
...
export function isOnSelectBound(bound, point) {
  ...
  const check2 = Math.abs(x - (bound.x + bound.width)) <= 10 && bound.y + bound.height >= y && y >= bound.y;
  const check3 = Math.abs(y - bound.y) <= 10 && bound.x + bound.width >= x && x >= bound.x;
  const check4 = Math.abs(y - (bound.y + bound.height)) <= 10 && bound.x + bound.width >= x && x >= bound.x;
 ...
 */
export function getAngleByThreePoint(p1 = { x: 0, y: 0 }, p2 = { x: 0, y: 0 }, p3 = { x: 0, y: 0 }) {
